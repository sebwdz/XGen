...
#include "../VirtualMachineV2/include/Engine.hpp"
...
void *Engine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "PluginMachine"))
        return static_cast< PluginMachine*>(const_cast< Engine*>(this));
    if (!strcmp(_clname, "plugin machine"))
        return static_cast< PluginMachine*>(const_cast< Engine*>(this));
